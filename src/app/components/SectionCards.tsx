...
// Plugion do scroll para utilizar no gsap dentro de código
    ...
    return (
        <section className="w-full pb-20" ref={sectionRef}>
            <Image
                src={Mockup}
                alt="Mockup main"
                className="sticky top-56 mx-auto -mt-[32rem] mb-16 opacity-0"
                ref={mockupRef}
            />
            <h2 className="text-center text-7xl font-semibold text-black mb-40 opacity-0" ref={titleRef}>
                Faça <span className="text-green-700">você</span> mesmo de casa
            </h2>

            <div className="relative w-full max-w-area-cards h-area-cards mx-auto">
                <Image className="absolute top-8 left-44 opacity-0" src={Card01} alt="Card01" ref={card01Ref} />
                <Image className="absolute left-0 bottom-32 opacity-0" src={Card02} alt="Card02" ref={card02Ref} />
                <Image className="absolute bottom-0 left-80 opacity-0" src={Card03} alt="Card03" ref={card03Ref} />
                <Image className="absolute top-0 right-36 opacity-0" src={Card04} alt="Card04" ref={card04Ref} />
                <Image className="absolute right-0 bottom-28 opacity-0" src={Card05} alt="Card05" ref={card05Ref} />
                <Image className="absolute bottom-0 right-80 opacity-0" src={Card06} alt="Card06" ref={card06Ref} />
            </div>
        </section>
    )
}